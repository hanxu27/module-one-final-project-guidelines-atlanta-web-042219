class Coach < ActiveRecord::Base
    ...
    def new_eval(tryout_number:, setting:)
        # , passing:, hitting:, emotions:, talking:, learning:
        player = Player.find(tryout_number)
        tryout = Tryout.create(player_id: player.id, coach_id: self.id, setting: setting)
        # , passing: passing, hitting: hitting, emotions: emotions, talking: talking, learning: learning
